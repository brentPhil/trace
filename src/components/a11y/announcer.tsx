 ...
 * The live region.
 *
 * Starting and stopping a timer changes almost nothing visually â€” a button's
 ...
 * live region whose text does not change is not re-announced â€” so stopping two
