/*
 * /reports — THE PAGE, NOT THE ROUTE. The route definition and its loader stay
 * in reports.tsx; the `-` prefix keeps this file out of the route tree, the
 * same convention the tests beside it already use.
 *
 * The component lives here because it has to be EXPORTED — -reports.test.tsx
